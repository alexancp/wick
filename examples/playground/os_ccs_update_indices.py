...
from wick.convenience import one_e_spin, two_e_spin, e_pqrs_operator
...
bath_dict = {i : "I" for i in o_general}
bath_dict.update({a : "A" for a in v_general})
print(find_and_replace_external_indices(nice, bath_dict))
...
print("\nRHS spin-adapted expression:")
nice = make_nice_string(str(final))
bath_dict = {i : "I" for i in o_general[1:]}
bath_dict.update({a : "A" for a in v_general[1:]})
print(find_and_replace_external_indices(nice, bath_dict))
